  ...
  return (
    ...
    <div className='w-[400px] min-h-[240px] border-2 mx-auto mt-[180px] p-[16px] rounded-md bg-white laptop:w-[460px]'>
        ...
        <form className='flex flex-col gap-6' onSubmit={verification}>
            ...
            <input type='password' placeholder='Enter new password' className='py-[0.5rem] px-[1rem] rounded-sm leading-[1.3rem]' value={password} onChange={(e)=>setPassword(e.target.value)}/>
            ...
            <input type='password' placeholder='Confirm new password' className='py-[0.5rem] px-[1rem] rounded-sm leading-[1.3rem]'value={confpassword} onChange={(e)=>setConfpassword(e.target.value)} />
